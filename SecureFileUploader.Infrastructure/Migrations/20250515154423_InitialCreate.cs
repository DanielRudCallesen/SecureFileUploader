        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedAesKey = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileMetadata_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedAesKey = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    AccessCode = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    AccessCodeExpiry = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileShareInvitations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileShareInvitations_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FileShareInvitations_FileMetadata_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileShareInvitations_FileId",
                table: "FileShareInvitations",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_FileShareInvitations_OwnerId",
                table: "FileShareInvitations",
                column: "OwnerId");
